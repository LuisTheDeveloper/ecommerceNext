...
function Cart() {
  ...
  const handleCheckout = async () => {
    ...
    // create one instance of a checkout for this specific user and will stay alive in the backend
                  ...
                  <div>
                    <p className="quantity-desc">
                      <span
                        ...
                        onKeyDown={() => toggleCartItemQuantity(item._id, 'dec')}
                      >
                        <AiOutlineMinus />
                      </span>
                      ...
                      <span
                        ...
                        onKeyDown={() => toggleCartItemQuantity(item._id, 'inc')}
                      >
                        <AiOutlinePlus />
                      </span>
                    </p>
